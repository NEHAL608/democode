...
#define HEADER0 0x5A
#define HEADER1 0xA5/* Configuration */
...
#define DGUS_BUZZER_OFF      ((unsigned long)0x007D4000)
#define DGUS_BUZZER_ON       ((unsigned long)0x007D4002)
...
write
*/
//#define DGUS_CONFIG_SET     ((unsigned long)0x5A00003F) /** Last 1 digit used for config changed according application**/
 ...
 */
#define DGUS_OK                       1   /**< Everything was fine */
#define DGUS_TIMEOUT                  1   /**< Timed out waiting for OK */
#define DGUS_ERROR                    0   /**< Unspecified serious error */
