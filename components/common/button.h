...
void GPIO_init(void);
/**
 * @brief Suspends power button callbacks until power button_resume is called.
 **/
void power_button_suspend();
/**
 * @brief Resumes suspended power button.
 */
void power_button_resume();
