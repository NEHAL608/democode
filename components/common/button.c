...
button_context_ptr pwr_ctx = NULL;

// extern void intrrupt__handler(void *arg, const struct button_data *data);
// extern void mainbutton_handler(void *arg, const struct button_data *data);
...
//     struct button_config powerbtn_cfg =
//     {
//         .level = 0,
//         .internal_pull = 1,
//         .long_press_ms = 2000,
//         .continuous_callback = 0,
//         .on_press = NULL,
//         .on_release = mainbutton_handler,
//     };
...
//     .continuous_callback = 0,
//     .on_press = NULL,
//     .on_release = intrrupt__handler,
//   };
 

//  // ESP_ERROR_CHECK(button_config(PW_BTN, &powerbtn_cfg, &pwr_ctx));
//   ESP_ERROR_CHECK(button_config(TMP_ALERT, &btn_cfg, NULL));
//   ESP_ERROR_CHECK(button_config(IMU_INTRPT, &btn_cfg, NULL));

// }



void power_button_suspend(void)
{
    button_suspend(pwr_ctx);
}

void power_button_resume(void)
{
    button_resume(pwr_ctx);
}